...
class DbUtilInteractionTest : BaseRobolectricTest() {
    ...
    fun givenInteractionProvided_whenPutInteraction_thenContentValuesUpdated() {
        ...
        val keySet = arrayOf(
            DbSchema.InteractionSchema.COLUMN_INTERACTION_ID,
            DbSchema.InteractionSchema.COLUMN_INTERACTION_STATUS,
            DbSchema.InteractionSchema.COLUMN_INTERACTION_TIME,
            DbSchema.InteractionSchema.COLUMN_INTERACTION_TOKEN
        )
        ...
        assertEquals(INTERACTION_ID, contentValues.get(DbSchema.InteractionSchema.COLUMN_INTERACTION_ID))
        assertEquals(INTERACTION_STATUS.toString(), contentValues.get(DbSchema.InteractionSchema.COLUMN_INTERACTION_STATUS))
        assertEquals(INTERACTION_TIME, contentValues.get(DbSchema.InteractionSchema.COLUMN_INTERACTION_TIME))
        assertEquals(INTERACTION_TOKEN, contentValues.get(DbSchema.InteractionSchema.COLUMN_INTERACTION_TOKEN))
    }
