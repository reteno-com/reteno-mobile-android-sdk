...
class DbUtilEventsTest : BaseRobolectricTest() {
    ...
    fun givenEventsProvided_whenToContentValuesList_thenContentValuesListReturned() {
        // Given
        val parameter1 = ParameterDTO(name = FIELD_PARAM_NAME_1, value = FIELD_PARAM_VALUE_1)
        val parameter2 = ParameterDTO(name = FIELD_PARAM_NAME_2, value = FIELD_PARAM_VALUE_2)
        val params1 = listOf(parameter1, parameter2)
        val params2 = listOf(parameter2, parameter1)

        val event1 = EventDTO(eventTypeKey = EVENT_1_TYPE_KEY, occurred = EVENT_1_OCCURRED, params = params1)
        val event2 = EventDTO(eventTypeKey = EVENT_2_TYPE_KEY, occurred = EVENT_2_OCCURRED, params = params2)
        val event3 = EventDTO(eventTypeKey = EVENT_3_TYPE_KEY, occurred = EVENT_3_OCCURRED, params = null)
    ...
    fun givenEventFull_whenGetEvent_thenEventReturned() {
        ...
        val expectedParams = listOf(ParameterDTO(FIELD_PARAM_NAME_1, FIELD_PARAM_VALUE_1), ParameterDTO(FIELD_PARAM_NAME_2, FIELD_PARAM_VALUE_2))
        val expectedEvent = EventDTO(
