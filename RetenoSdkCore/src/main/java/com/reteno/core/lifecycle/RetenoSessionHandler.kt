...
internal class RetenoSessionHandler(private val sharedPrefsManager: SharedPrefsManager) {

    var foregroundTimeMillis: Long = 0L
    ...
    fun scheduleInAppMessages(messages: MutableList<InAppWithTime>, onTimeMatch: (List<InAppMessage>) -> Unit) {
    ...
    companion object {
        ...
        private const val SESSION_RESET_TIME = 10L * 1000L//30L * 60L * 1000L
    }
}