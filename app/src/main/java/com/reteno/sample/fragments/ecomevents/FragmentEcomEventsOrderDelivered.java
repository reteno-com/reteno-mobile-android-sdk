...
public class FragmentEcomEventsOrderDelivered extends BaseEcomEventsFragment {

    private FragmentEcomEventsOrderDeliveredBinding binding;


    public FragmentEcomEventsOrderDelivered() {
