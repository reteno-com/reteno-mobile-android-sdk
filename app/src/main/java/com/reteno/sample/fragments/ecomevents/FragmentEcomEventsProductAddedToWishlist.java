...
public class FragmentEcomEventsProductAddedToWishlist extends BaseEcomEventsFragment {

    private FragmentEcomEventsProductAddedToWishlistBinding binding;


    public FragmentEcomEventsProductAddedToWishlist() {
    ...
    private void initListeners() {
        binding.btnSubmit.setOnClickListener(v -> {
            ...
            EcomEvent ecomEvent = new EcomEvent.ProductAddedToWishlist(productView, Util.getTextOrNull(binding.etCurrencyCode));
